...
class MassDeleteCronSyncData extends Action
{
     ...
     * @param \DamConsultants\Akima\Model\BynderSycDataFactory $bynderFactory
     */
    public function __construct(
        ...
        \DamConsultants\Akima\Model\BynderSycDataFactory $bynderFactory
    ) {
        $this->filter = $filter;
    ...
    {
        return $this->authorization->isAllowed('DamConsultants_Akima::cron_massdelete');
    }
    /**
     * Execute
     */
