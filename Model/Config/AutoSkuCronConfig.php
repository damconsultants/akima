...
class AutoSkuCronConfig extends \Magento\Framework\App\Config\Value
{
    ...
    public function afterSave()
    {
        ...
        try {
            $this->_configValueFactory->create()->load(
                'crontab/default/jobs/damConsultants_bynder_auto_sku_add_magento/schedule/cron_expr',
                'path'
            )->setValue(
                $cronExprString
            )->setPath(
            ...
            $this->_configValueFactory->create()->load(
                'crontab/default/jobs/damConsultants_bynder_auto_sku_add_magento/run/model',
                'path'
            )->setValue(
                $this->_runModelPath
            )->setPath(
    ...
    public function getConfigValue()
    {
        ...
        return $scopeConfig->getValue(
            "cronimageconfig/auto_add_bynder/your_min_auto_add_sku_frequency",
