...
namespace DamConsultants\Akima\Block\Adminhtml\Metaproperty;

use DamConsultants\Akima\Model\ResourceModel\Collection\MetaPropertyCollectionFactory;
use DamConsultants\Akima\Model\ResourceModel\Collection\DefaultMetaPropertyCollectionFactory;
...
class Index extends \Magento\Backend\Block\Template
{
    ...
    /**
     * @var \DamConsultants\Akima\Model\MetaPropertyFactory
     */
    protected $_metaProperty;

    /**
     * @var \DamConsultants\Akima\Model\ResourceModel\Collection\MetaPropertyCollectionFactory
     */
     ...
     * @param \DamConsultants\Akima\Helper\Data $helperdata
     * @param \DamConsultants\Akima\Model\MetaPropertyFactory $metaProperty
    ...
    public function __construct(
        ...
        \DamConsultants\Akima\Helper\Data $helperdata,
        \DamConsultants\Akima\Model\MetaPropertyFactory $metaProperty,
    ...
    public function getMetaData()
    {
        ...
        if (count($colletion_get_data) > 0) {
            ...
            : '0';
            $response_data['image_order']   = '0'; // retained for backward compatibility with existing DB rows
            $response_data['manage_assets'] = '0'; // retained for backward compatibility with existing DB rows
        } else {
