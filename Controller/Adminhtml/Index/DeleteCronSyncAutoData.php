...
class DeleteCronSyncAutoData extends Action
{
     ...
     * @param DamConsultants\Akima\Model\BynderAutoReplaceDataFactory $BynderSycDataFactory
     */
    public function __construct(
        Context $context,
        \DamConsultants\Akima\Model\BynderAutoReplaceDataFactory $BynderSycDataFactory
    ) {
