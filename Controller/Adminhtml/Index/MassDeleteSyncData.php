...
use DamConsultants\Akima\Model\ResourceModel\Collection\BynderConfigSyncDataCollectionFactory;
...
class MassDeleteSyncData extends Action
{
     ...
     * @param \DamConsultants\Akima\Model\BynderConfigSyncDataFactory $bynderFactory
     */
    public function __construct(
        ...
        \DamConsultants\Akima\Model\BynderConfigSyncDataFactory $bynderFactory
    ) {
        $this->filter = $filter;
    ...
    {
        return $this->authorization->isAllowed('DamConsultants_Akima::massdelete');
    }
    /**
     * Execute
     */
