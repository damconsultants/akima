<?php
namespace DamConsultants\Akima\Block\Adminhtml\Catalog\Product\Form;
...
class Gallery extends \Magento\Backend\Block\Template
{
     ...
     * @param \DamConsultants\Akima\Helper $helper
     */
    public function __construct(
        ...
        \DamConsultants\Akima\Helper\Data $helper
    ) {
    ...
    {
        return $this->getViewFileUrl('DamConsultants_Akima::images/drag.png');
    }
    /**
     * Image.
     *
    ...
    {
        return $this->getViewFileUrl('DamConsultants_Akima::images/delete_.avif');
    }
    /**
     * Json.
     *
